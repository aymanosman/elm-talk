...
Elm.App.make = function (_elm) {
   ...
   var _op = {};
   var mySig = function () {
      var multOf5 = function (_p0) {    var _p1 = _p0;return _U.eq(A2($Basics._op["%"],_p1._0,5),0) && _U.eq(A2($Basics._op["%"],_p1._1,5),0);};
      return A3($Signal.filter,multOf5,{ctor: "_Tuple2",_0: 0,_1: 0},$Mouse.position);
   }();
   var toJSPort = Elm.Native.Port.make(_elm).outboundSignal("toJSPort",function (v) {    return [v._0,v._1];},$Mouse.position);
   var toElmPort = Elm.Native.Port.make(_elm).inboundSignal("toElmPort",
   "String",
   function (v) {
      return typeof v === "string" || typeof v === "object" && v instanceof String ? v : _U.badPort("a string",v);
   });
   var main = function () {    var view = function (s) {    return $Html.text(A2($Basics._op["++"],"From JS: ",s));};return A2($Signal.map,view,toElmPort);}();
   return _elm.App.values = {_op: _op,main: main,mySig: mySig};
};
